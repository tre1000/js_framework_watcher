<template>
  <div class="home">
    ...
    <br>
    <h1>Angular</h1>
    <h3>{{ angularWatchers }}</h3>
    <br>
    <h1>Svelte</h1>
    <h3>{{ svelteWatchers }}</h3>
    <br>
    <h1>React</h1>
    <h3>{{ reactWatchers }}</h3>
    <br>
